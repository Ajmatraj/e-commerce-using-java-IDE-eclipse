  ...
  <div class="firstcard">
      ...
      <div class="card-1">
        <div class="cardimage-1">
          <figure class="card-images">
            <img src="${pageContext.request.contextPath}/Resources/Images/products/galaxy-s24-ultra.jpg" alt="Samsung Galaxy S24 Ultra" />
            <div>
              <a href="${pageContext.request.contextPath}/pages/Product.jsp"><img class="left-icon" src="${pageContext.request.contextPath}/Resources/Images/products/icons8-plus.svg" alt="Plus Icon" /></a>
            </div>
          </figure>
        </div>
        <div class="cardtxt-1">
          <h3>Samsung Galaxy S24 Ultra</h3>
          <p>ProVisual Engine</p>
    ...
    <div class="sec-containerCard-1">
      <div class="card-1">
        <div class="cardimage-1">
          <figure class="card-images">
            <img src="${pageContext.request.contextPath}/Resources/Images/products/iPhone-15-Pro-Max-Tren-tay-9.jpg" alt="iPhone 15 Pro" />
            <div>
              <a href="${pageContext.request.contextPath}/pages/Product.jsp"><img class="left-icon" src="${pageContext.request.contextPath}/Resources/Images/products/icons8-search.svg" alt="Search Icon" /></a>
            </div>
          </figure>
        </div>
        <div class="cardtxt-1">
    ...
    <div class="sec-containerCard-1">
      <div class="card-1">
        <div class="cardimage-1">
          <figure class="card-images">
            <img src="${pageContext.request.contextPath}/Resources/Images/products/OnePlus.jpg" alt="OnePlus 12" />
            <div>
              <a href="${pageContext.request.contextPath}/pages/Product.jsp"><img class="left-icon" src="${pageContext.request.contextPath}/Resources/Images/products/icons8-checkmark.svg" alt="Checkmark Icon" /></a>
            </div>
          </figure>
        </div>
        <div class="cardtxt-1">
